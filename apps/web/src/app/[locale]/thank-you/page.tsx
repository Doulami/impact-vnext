      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">
          <div className="max-w-md w-full text-center p-8">
            <h1 className="text-2xl font-bold text-gray-900 mb-4">{t('orderNotFound')}</h1>
  ...
  if (!order || !order.lines) {
    ...
    return (
      <div className="min-h-screen bg-white">
        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">
          <div className="max-w-md w-full text-center p-8">
            <h1 className="text-2xl font-bold text-gray-900 mb-4">{t('orderDataIncomplete')}</h1>
            <p className="text-gray-600 mb-6">{t('orderDataIncompleteDesc')}</p>
            <Button
              as="link"
              href={`/${locale}`}
              variant="primary"
      ...
      <div className="bg-gray-50 min-h-screen py-12">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-lg shadow-sm p-8 text-center mb-6">
            ...
            <p className="text-gray-600 mb-4">{t('orderReceived')}</p>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
            ...
            <div className="border-t pt-4 space-y-2">
              ...
              <div className="flex justify-between text-sm">
                <span className="text-gray-600">{t('shipping')} ({shippingMethod}):</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              <div className="flex items-center mb-4">
                ...
                <h3 className="font-bold text-gray-900">{t('shippingAddress')}</h3>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              <div className="flex items-center mb-4">
                ...
                <h3 className="font-bold text-gray-900">{t('confirmationSentTo')}</h3>
              </div>
              <div className="text-sm text-gray-600 space-y-1">
          ...
          {/* What's Next */}
          <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
            <h3 className="font-bold text-gray-900 mb-4">{t('whatHappensNext')}</h3>
            <div className="space-y-3">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">{t('orderProcessingDesc')}</p>
                </div>
              </div>
              <div className="flex items-start">
                <div className="w-8 h-8 bg-[var(--brand-primary)] text-white rounded-full flex items-center justify-center flex-shrink-0 mr-3">
                ...
                <div>
                  <p className="font-medium text-gray-900">{t('shipmentTracking')}</p>
                  <p className="text-sm text-gray-600">{t('shipmentTrackingDesc')}</p>
                </div>
              </div>
              <div className="flex items-start">
                <div className="w-8 h-8 bg-[var(--brand-primary)] text-white rounded-full flex items-center justify-center flex-shrink-0 mr-3">
                ...
                <div>
                  <p className="font-medium text-gray-900">{t('deliveryPayment')}</p>
                  <p className="text-sm text-gray-600">{t('deliveryPaymentDesc', { amount: `$${totalAmount}` })}</p>
                </div>
              </div>
            </div>
          </div>
