        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              <h3 className="font-semibold text-gray-900 mb-4">{t('accountInfo')}</h3>
              <div className="space-y-3">
                <div className="flex items-center">
                  <Mail className="h-4 w-4 text-gray-400 me-3" />
                  <div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-900">{t('accountId')}</p>
                    <p className="text-sm text-gray-600">{customer.id}</p>
                  </div>
                </div>
              </div>
              <p className="text-xs text-gray-500 mt-4">
                {t('changeEmailContact')}
              </p>
            </div>
          </div>
                ...
                <div>
                  ...
                  <div className="mt-1 relative rounded-md shadow-sm">
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`block w-full ps-10 pe-3 py-2 border rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 ${
