...
export default function SecuritySettings() {
  ...
  const validateForm = () => {
    ...
    if (!formData.newPassword) {
      ...
      errors.newPassword = t('passwordComplexity');
    }
  ...
  const getPasswordStrength = (password: string) => {
    ...
    if (strength <= 2) return { label: t('weak'), color: 'red', width: '33%' };
    if (strength <= 3) return { label: t('fair'), color: 'yellow', width: '66%' };
    return { label: t('strong'), color: 'green', width: '100%' };
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <nav className="bg-white rounded-lg shadow-sm p-6">
              <h2 className="font-semibold text-gray-900 mb-4">{tAccount('settings')}</h2>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 mt-6">
              <h3 className="font-semibold text-gray-900 mb-4">{t('securityStatus')}</h3>
              <div className="space-y-3">
                <div className="flex items-center">
                  <Shield className={`h-4 w-4 mr-3 ${user?.verified ? 'text-green-500' : 'text-yellow-500'}`} />
                  <div>
                    <p className="text-sm font-medium text-gray-900">{t('accountStatus')}</p>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-900">{t('twoFactorAuth')}</p>
                    <p className="text-sm text-gray-600">{t('notEnabled')}</p>
                  </div>
                </div>
              </div>
              <div className="mt-4 p-3 bg-blue-50 rounded-md">
                <p className="text-xs text-blue-700">
                  <strong>Tip:</strong> {t('securityTip')}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 mt-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">{t('additionalSecurity')}</h3>
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                  <div>
                    <h4 className="font-medium text-gray-900">{t('twoFactorAuthentication')}</h4>
                ...
                <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                  <div>
                    <h4 className="font-medium text-gray-900">{t('loginHistory')}</h4>
                    <p className="text-sm text-gray-600">{t('loginHistoryDescription')}</p>
                  </div>
                  <button
                    disabled
                    className="px-4 py-2 text-sm font-medium text-gray-400 bg-gray-100 border border-gray-200 rounded-md cursor-not-allowed"
